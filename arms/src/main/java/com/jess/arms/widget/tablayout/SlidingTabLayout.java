package com.jess.arms.widget.tablayout;
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextSelectSize = ta.getDimension(R.styleable.SlidingTabLayout_tl_textSelectSize, sp2px(17));
        mTextUnSelectSize = ta.getDimension(R.styleable.SlidingTabLayout_tl_textUnselectSize, sp2px(17));
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                ...
                tv_tab_title.setTextSize(i == mCurrentTab ? px2sp(getContext(), mTextSelectSize) : px2sp(getContext(), mTextUnSelectSize));
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (tab_title != null) {
                ...
                tab_title.setTextSize(isSelect ? px2sp(getContext(), mTextSelectSize) : px2sp(getContext(), mTextUnSelectSize));
    ...
    public void setmTextSelectSize(float textSelectSize) {
        mTextSelectSize = textSelectSize;
        updateTabStyles();
    }

    public void setmTextUnSelectSize(float textUnSelectSize) {
        mTextUnSelectSize = textUnSelectSize;
        updateTabStyles();
    }
